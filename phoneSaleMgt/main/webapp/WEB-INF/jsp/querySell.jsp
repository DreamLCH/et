...
<title><s:message code="sellQuery"></s:message></title>
<style>
* {
	margin: 0;
	padding: 0;
...
*/
	function clickDelete(value){
		$.getJSON("/delete/sell?id="+value,function(data){
			alert("删除成功。");
		...
		>
			<thead>
				<tr bgcolor="#FFFFFF" height=45>
					...
					<th data-field="brand" data-align="center"><s:message code="phoneBrand"></s:message></th>
					<th data-field="s_type" data-align="center"><s:message code="phoneType"></s:message></th>
					<th data-field="number" data-align="center"><s:message code="sellAmount"></s:message></th>
