...
@WebServlet("/AreaStatisticsServlet")
public class AreaStatisticsServlet extends SuperClassServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//查询页面显示所需的数据
		ArrayList list = sellService.queryAllArea(year, behavior);
		...
		//页面转发的地址
		req.getRequestDispatcher("areaStatistics").forward(req, resp);
	}
